(function () {
  ...
  var fallbackConfig = {
    ...
    defaultVisibleColumns: ["品牌", "车系", "车型名称", "年款", "级别", "能源类型", "官方指导价", "上市时间", "交叉核验", "百公里加速(s)", "纯电续航(km)", "NOA城市领航", "远程启动", "远程控制", "蓝牙/数字钥匙", "座椅记忆", "外后视镜记忆", "最高车速(km/h)", "前悬挂形式", "后悬挂形式", "车门数(个)", "驱动方式", "整备质量(kg)", "辅助驾驶级别", "OTA升级", "驱动电机数"],
    conditions: [],
