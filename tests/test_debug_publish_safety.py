...
class WorkflowValidatorTests(unittest.TestCase):
    ...
    def test_partial_missing_stable_uses_pages_source_baseline_before_skip(self) -> None:
        ...
        self.assertIn("dongchedi_pages_baseline.json", text)
        self.assertLess(text.find(fallback), text.find('echo "爬虫 stable artifact 尚未齐备，交由完整性校验安全跳过"'))
...
class FilterPagesSourceBaselineTests(unittest.TestCase):
    ...
    def test_pages_fallback_keeps_only_exact_single_source_and_reports_cross_source(self) -> None:
        rows = [
            {"数据来源": "仅懂车帝", "品牌": "甲", "车系": "甲车系", "车型名称": "甲 2026款", "年款": "2026", "官方指导价": "12.98万", "上市时间": "2026-01-01"},
            {"数据来源": "汽车之家+懂车帝(车系级)", "品牌": "甲", "车系": "甲车系", "车型名称": "甲 2026款", "年款": "2026", "官方指导价": "12.98万", "上市时间": "2026-01-01"},
            {"数据来源": "仅汽车之家", "品牌": "乙", "车系": "乙车系", "车型名称": "乙 2026款", "年款": "2026", "车款ID": "60001", "厂商指导价_元_": "129800", "上市时间": "2026-01-01"},
        ]
    ...
    def test_pages_fallback_drops_invalid_identity_before_writing_baseline(self) -> None:
        valid = {"数据来源": "仅汽车之家", "品牌": "甲", "车系": "甲车系", "车型名称": "甲 2026款", "年款": "2026", "车款ID": "54529", "厂商指导价_元_": "129800", "上市时间": "2026-01-01", "官方指导价": "129800"}
        dirty = {"数据来源": "仅汽车之家", "品牌": "甲", "车系": "modely-6224", "车型名称": "甲 2026款", "年款": "2026", "厂商指导价_元_": "129800", "上市时间": "2026-01-01"}
