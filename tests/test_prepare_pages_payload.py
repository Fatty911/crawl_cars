...
def test_prepare_rows_keeps_recent_sparse_rows_and_meaningful_zeroes():
    rows = [
        ...
        {"品牌": "乙", "车系": "乙车系", "车型名称": "易车旧款", "年款": "2021", "数据来源": "仅易车", "易车上市状态": "approved"},
        {"品牌": "乙", "车系": "乙车系", "车型名称": "易车新款 2026款", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "approved", "配置A": "有"},
    ]
...
def test_prepare_rows_rejects_dirty_yiche_identity_and_status():
    rows = [
        {"品牌": "特斯拉", "车系": "modely-6224", "车型名称": "Model Y 2026款", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "approved"},
        {"品牌": "特斯拉", "车系": "特斯拉Model Y", "车型名称": "Model Y 2026款", "年款": "", "数据来源": "仅易车", "易车上市状态": "approved"},
        {"品牌": "特斯拉", "车系": "特斯拉Model Y", "车型名称": "Model Y 2026款", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "unapproved"},
        {"品牌": "特斯拉", "车系": "特斯拉Model Y", "车型名称": "Model Y 2026款", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "approved"},
    ]
...
def test_prepare_rows_rejects_dirty_yiche_rows():
    rows = [
        {"品牌": "凯迪拉克", "车系": "vistiq-11581", "车型名称": "2026款 豪华版", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "approved"},
        {"品牌": "凯迪拉克", "车系": "凯威德", "车型名称": "2026款 基本型", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "unapproved"},
        {"品牌": "凯迪拉克", "车系": "凯威德", "车型名称": "2026款 豪华版", "年款": "2026", "数据来源": "仅易车", "易车上市状态": "approved"},
    ]
    assert MODULE.prepare_rows(rows, 2022) == [rows[2]]
